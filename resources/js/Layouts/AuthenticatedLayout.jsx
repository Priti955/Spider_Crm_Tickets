            ...
            <nav className="border-b border-blue-700 bg-blue-600">
                                    ...
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                ...
                                                className="inline-flex items-center rounded-md border border-transparent bg-blue-600 px-3 py-2 text-sm font-medium leading-4 text-blue-100 transition duration-150 ease-in-out hover:text-white focus:outline-none"
                                            >
                                                {user.name}
                ...
                <div
                    className={
                        ...
                        ' sm:hidden border-t border-blue-700 bg-blue-700'
                    }
                >
